...
//	}
//
// syncHomes   �C fetch all homes from the brand cloud and persist them.
// syncDevices �C fetch rooms + devices for a home; params: {"homeId":"xxx"}.
// getProps    �C read device properties; params are brand-specific.
// setProps    �C write device properties; params are brand-specific.
// execute     �C send an action command to a device; params are brand-specific.
type CLITool struct {
