...
Examples:
  homeocto model                    # Show current default model
  homeocto model gpt-5.2           # Set gpt-5.2 as default
  homeocto model claude-sonnet-4.6 # Set claude-sonnet-4.6 as default
  homeocto model local-model       # Set local VLLM server as default
